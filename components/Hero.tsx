  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="bg-grid absolute inset-0 opacity-[0.5] [mask-image:radial-gradient(ellipse_70%_60%_at_50%_40%,black,transparent)]" />
      ...
      {/* Wordmark + CTAs */}
      <div className="container-shell relative z-10 flex flex-1 flex-col items-center justify-center py-24 text-center">
        ...
        <div className="hero-cta mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <Link
            href="/#contact"
            className="inline-block rounded-full bg-brand-indigo px-8 py-4 text-base font-semibold text-[#0c0c30] shadow-[0_8px_30px_rgba(11,27,63,0.5)] transition-all duration-300 ease-out-expo hover:brightness-125 active:scale-[0.98]"
          >
            Join the Society
          </Link>
          <Link
            href="/#domains"
            className="btn-ghost inline-block rounded-full px-8 py-4 text-base font-semibold"
          >
            Explore the domains
          </Link>
        </div>
      ...
      <div className="hero-corner container-shell relative z-10 flex w-full items-end justify-between gap-6 pt-16 font-mono text-[0.6rem] uppercase leading-relaxed tracking-[0.18em] text-ink-secondary sm:text-[0.7rem]">
        <div className="w-1/2">
